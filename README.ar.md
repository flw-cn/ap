...
في الخاص بك`~/.bashrc`يضاف إليها ما يلي:
...
في الخاص بك`~/.config/fish/config.fish`يضاف إليها ما يلي:
...
في الخاص بك`~/.zshrc`يضاف إليها ما يلي:
...
-   هناك أوامر تكتشف المحطة وتوفر مخرجات مختلفة للوضع الطرفي والوضع غير الطرفي ، فهل ستغير ناتجها؟
    -   متعود.
-   كيف يمكنني تشخيص ما إذا كنت أظن أن ap يؤثر على إخراج الأمر؟
...
-   إذا كنت عادةً ألحق الأمر بأمر ap`| less`هل ستكون هناك مشكلة؟
    -   متعود.
-   هل يمكن للأمر ap أيضًا إعادة توجيه مخرجاته؟
    -   تستطيع.
